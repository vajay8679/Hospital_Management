                                ...
                                <div id="collapseOne<?php echo $rows->id; ?>" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div style="padding: 10px;">
                                            <a class="btn btn-primary" href="<?php echo base_url() . 'index.php/faqquestion/show?faq_id=' . ($rows->id); ?>" data-toggle="tooltip" class="btn btn-default"></i>View Attachments</a>

                                        </div>
                                        <div class="col-lg-12 col-sm-12">
                                            <h4 class="text-justify"> <?php echo $rows->answer; ?> </h4>
                                        </div>
                                    </div>
                                </div>
                            </div>

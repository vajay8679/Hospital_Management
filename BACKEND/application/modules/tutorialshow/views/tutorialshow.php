        ...
        <div class="block full">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4 class="panel-title" data-toggle="collapse" data-target="#collapseOne<?php echo $rows->id; ?>">
                                        <i class="fa fa-angle-down" style="font-size:20px"></i>
                                        <?php echo $rows->tutorial; ?>
                                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="This section represents the antibiotic days saved sum cost saved." class="red-tooltip"></a>
                                    </h4>
                                </div>
                                <div id="collapseOne<?php echo $rows->id; ?>" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div style="padding: 10px;">
                                            <a class="btn btn-primary" href="<?php echo base_url() . 'index.php/tutorialshow/show?tutorial_id=' . ($rows->id); ?>" data-toggle="tooltip" class="btn btn-default"></i>View Attachments</a>

                                        </div>
                                        <div class="col-lg-12 col-sm-12">
                                            <h4 class="text-justify"> <?php echo $rows->description; ?> </h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- <div class="col-lg-12">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapse9">
                                <i class="fa fa-angle-down" style="font-size:20px"></i>
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapse10">
                                <i class="fa fa-angle-down" style="font-size:20px"></i>

                        ...
                        <ul class="sidebar-nav">
                            <?php if ($this->ion_auth->is_admin()) { ?>
                                ...
                                <li title="FaqQuestion
                                     '">
                                    <a href="<?php echo site_url('faq'); ?>" class=" <?php echo (strtolower($this->router->fetch_class()) == "faq") ? "active" : "" ?>"><i class="fa fa-question sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">FAQ</span></a>
                                </li>
                                <li title="Contact Us">
                                ...
                                <li title="Tutorial">
                                    <a href="<?php echo site_url('tutorials'); ?>" target="_blank" class=" <?php echo (strtolower($this->router->fetch_class()) == "howItWorks") ? "active" : "" ?>"><i class="fa fa-hand-o-right sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Tutorials</span></a>
                                </li>
                            ...
                            <?php } elseif ($this->ion_auth->is_facilityManager()) {  ?>
                                ...
                                <li title="Tutorial">
                                    <a href="<?php echo site_url('tutorialshow'); ?>" target="_blank" class=" <?php echo (strtolower($this->router->fetch_class()) == "tutorialshow") ? "active" : "" ?>"><i class="fa fa-hand-o-right sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Tutorials</span></a>
                                </li>
                                <li title="Recommendation">
                                    <a href="<?php echo site_url('recommendation'); ?>" class=" <?php echo (strtolower($this->router->fetch_class()) == "recommendation") ? "active" : "" ?>"><i class="fa fa-paper-plane sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Steward Communications</span></a>
                                </li>
